    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        FP.reBuild = function(resizing){
            ...
            $(SECTION_SEL).each(function(){
             ...
             /* external addition */
            if($('#znn_fullscreen_rows[data-animation="none"]').length == 0) { 
                $('#znn_fullscreen_rows').css('height', windowsHeight + 'px');
            }

            //middle alignment of rows when desktop scroll overflow is turned off
            if($('#znn_fullscreen_rows[data-content-overflow="hidden"]').length > 0) { 
            	$('#znn_fullscreen_rows>.vc_row.vc_row-flex:not(#footer-outer)>.fp-tableCell>.full-page-inner-wrap-outer>.full-page-inner-wrap[data-content-pos="middle"] > .full-page-inner>.container>.span_12').css('height', windowsHeight + 'px');
            	$('#znn_fullscreen_rows>.vc_row.vc_row-flex:not(#footer-outer)>.fp-tableCell>.full-page-inner-wrap-outer>.full-page-inner-wrap[data-content-pos="middle"]').css('overflow', 'hidden');
            }
        ...
        */
        function styleSection(section, index){
            ...
            if($('#znn_fullscreen_rows[data-content-overflow="hidden"]').length > 0) $('#znn_fullscreen_rows>.vc_row.vc_row-flex:not(#footer-outer)>.fp-tableCell>.full-page-inner-wrap-outer>.full-page-inner-wrap[data-content-pos="middle"] > .full-page-inner>.container>.span_12').css('height', windowsHeight + 'px');
        ...
        */
        ...
        function addVerticalNavigation(){
            if($('#znn_fullscreen_rows').attr('data-dot-navigation') == 'hidden') return;

            if($('#boxed').length > 0) 
            	$('#boxed').append('<div id="' + SECTION_NAV + '" class="'+$('#znn_fullscreen_rows').attr('data-dot-navigation')+'"><ul></ul></div>');
            else 
            	$body.append('<div id="' + SECTION_NAV + '" class="'+$('#znn_fullscreen_rows').attr('data-dot-navigation')+'"><ul></ul></div>');
            ...
            if($('#znn_fullscreen_rows[data-footer="last_row"]').length > 0 || $('#znn_fullscreen_rows[data-footer="default"]').length > 0)  
        ...
        */
        ...
        function scrollHandler(){
            ...
            if(!options.autoScrolling || options.scrollBar){
                ...
                console.log("SECTIUNEA: " + currentSection);
        ...
        function scrolling(type, scrollable){
            ...
            if(scrollable.length > 0 ){
                ...
                if(options.scrollOverflowHandler.isScrolled(check, scrollable)){
                	...
                	//* external addition */
                	if( $('#znn_fullscreen_rows.nextSectionAllowed').length > 0) {
                   		scrollSection();
                   	}
                    setTimeout(function(){ $('#znn_fullscreen_rows').addClass('nextSectionAllowed'); },150);
                }else{
                    return true;
                }
            }else{
        ...
        */
        function scrollPage(element, callback, isMovementUp){
        	/* external addition of ||canScroll */
        ...
        */
        function performMovement(v){
            ...
            if($('#znn_fullscreen_rows[data-animation-speed="medium"]').length > 0)
                    var $timeOutDur = ($('.last-before-footer').length == 0) ? 910 : 530;
                else if($('#znn_fullscreen_rows[data-animation-speed="slow"]').length > 0)
                    var $timeOutDur = ($('.last-before-footer').length == 0) ? 1200 : 530;
                else
                    var $timeOutDur = ($('.last-before-footer').length == 0) ? 720 : 530;

            // using CSS3 translate functionality
            if (options.css3 && !options.scrollBar && $('#znn_fullscreen_rows[data-animation="none"]').length == 0) {
      ...
      $('#znn_fullscreen_rows').removeClass('trans-animation-active');
        ...
        */
        function playMedia(destiny){
            ...
            destiny.find('video.external-video-bg').each(function(){
            ...
            //youtube videos
            destiny.find('.external-youtube-bg iframe[src*="youtube.com/embed/"]').each(function(){
                var element = $(this).get(0);
        ...
        */
        ...
        function sectionBulletHandler(e){
            e.preventDefault();
            /* external addition */
            if($('#znn_fullscreen_rows .wpb_row.transition-out').length == 0) {
        ...
        */
        ...
        function resizeHandler(){
        	if($('#znn_fullscreen_rows.afterLoaded').length == 0) return false;
        ...
        */
        function createSlimScrolling(element){
        	...
        	var $fpScrollOverflow = ($('#znn_fullscreen_rows').attr('data-content-overflow') == 'hidden') ? false : true;
            ...
            //needs scroll?
             if ( contentHeight > windowsHeight+5 && $(element).find('.external-slider-wrap[data-fullscreen="true"]').length == 0 && !($(window).width() > 1000 && $fpScrollOverflow == false) ) {
    ...
    var iscrollHandler = {
        ...
        */
        ...
        isScrolled: function(type, scrollable) {
            ...
            /* external addition */
            if (type === 'top') {
            	$('#znn_fullscreen_rows').addClass('nextSectionAllowed');
